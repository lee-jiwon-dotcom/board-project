...
<form action="{{ route('posts.index') }}" method="GET" class="mb-6" autocomplete="off">
    <div class="flex gap-2" >
        ...
        <button type="submit" 
                class="inline-flex items-center px-4 py-2 bg-gray-700 border border-transparent rounded-md font-semibold text-xs text-blue-600 uppercase tracking-widest hover:bg-gray-600 focus:outline-none transition">
            🔍 검색
        </button>
        @if($search)
